...
vim.keymap.set(
  ...
  "<leader>l",
  "<cmd>set list!<cr>",
  { desc = "Toggle vim.opt.list", noremap = true }
)
...
vim.keymap.set(
  ...
  { desc = "Go to previous [D]iagnostic message", noremap = true }
)
vim.keymap.set(
  "n",
  "]d",
  vim.diagnostic.goto_next,
  { desc = "Go to next [D]iagnostic message", noremap = true }
)
vim.keymap.set(
  "n",
  "<leader>e",
  vim.diagnostic.open_float,
  { desc = "Show diagnostic [E]rror messages", noremap = true }
)
vim.keymap.set(
  "n",
  "<leader>q",
  vim.diagnostic.setloclist,
  { desc = "Open diagnostic [Q]uickfix list", noremap = true }
)
